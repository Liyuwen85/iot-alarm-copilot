...
$env:BRIDGE_KAFKA_TOPIC = $KafkaTopic
...
Write-Host "mqttBroker=$MqttBrokerUrl kafkaBootstrap=$KafkaBootstrapServers kafkaTopic=$KafkaTopic leaderLockKey=$LeaderLockKey"
